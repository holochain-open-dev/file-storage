    ...
    doDecodeSync() {
        DECODE: while (true) {
            ...
            if (headByte >= 0xe0) {
                ...
                throw new DecodeError_1.DecodeError(`Unrecognized type byte: ${prettyByte_1.prettyByte(headByte)}`);
            }
            this.complete();
        ...
        switch (headByte) {
            ...
            default: {
                if (headByte < 0xa0) {
                    ...
                    throw new DecodeError_1.DecodeError(`Unrecognized array type byte: ${prettyByte_1.prettyByte(headByte)}`);
                }
            }
        }
    }
