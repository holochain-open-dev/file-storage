...
class TestScheduler {
    ...
    async startSession(session) {
        ...
        try {
            await async_1.withTimeout(updatedSession.browser.startSession(updatedSession.id, createSessionUrl_1.createSessionUrl(this.config, updatedSession)), TIMEOUT_MSG, this.config.browserStartTimeout);
