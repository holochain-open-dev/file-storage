...
export type Element = object | parse5.DefaultTreeElement;
export type Attribute = parse5.Attribute;
export type Node = object | parse5.DefaultTreeNode;
export type ParentNode = object | parse5.DefaultTreeParentNode;
export type ChildNode = object | parse5.DefaultTreeChildNode;
export type DefaultTreeElement = parse5.DefaultTreeElement;
export type DefaultTreeNode = parse5.DefaultTreeNode;
export type DefaultTreeChildNode = parse5.DefaultTreeChildNode;
export type DefaultTreeCommentNode = parse5.DefaultTreeCommentNode;
export type DefaultTreeTextNode = parse5.DefaultTreeTextNode;
/**
 ...
 */
export function createElement(tagName: string, attrs?: Record<string, string>, namespaceURI?: string): parse5.Element;
/**
 * Creates a script element.
 * @param {Record<string,string>} [attrs]
 * @param {string} [code]
 */
export function createScript(attrs?: Record<string, string> | undefined, code?: string | undefined): parse5.Element;
/**
 * @param {string} html
 */
