...
export declare function isInlineScriptRequest(ctx: Context): boolean;
export declare function getRequestBrowserPath(context: Context): string;
export declare function getRequestFilePath(context: Context, rootDir: string): string;
