...
exports.deserialize = exports.MARKER_BROWSER_ERROR = void 0;
const KEY_WTR_TYPE = '__WTR_TYPE__';
const KEY_CONSTRUCTOR_NAME = '__WTR_CONSTRUCTOR_NAME__';
exports.MARKER_BROWSER_ERROR = '__WTR_BROWSER_ERROR__';
    ...
    return function reviver(key, value) {
        ...
        if (hasOwnProperty.call(value, KEY_WTR_TYPE)) {
            switch (value[KEY_WTR_TYPE]) {
                ...
                case 'Error': {
                    return { [exports.MARKER_BROWSER_ERROR]: true, message: value.message, stack: value.stack };
                }
                case 'Promise':
